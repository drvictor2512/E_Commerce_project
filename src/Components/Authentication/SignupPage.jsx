...
const SignupPage = () => {
    ...
    return (
        <section className='align_center form_page' onSubmit={handleSubmit(onSubmit)}>
            <form className='authentication_form signup_form'>
                ...
                <div className='image_input_section'>
                    ...
                    <input type='file' id='file-ip-1' className='image_input' onChange={e => setImage(e.target.files[0])}/>
                </div>
                ...
                <div className='form_input signup_form_input'>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            {...register("cpPassword")}
                        />
                        {errors.cpPassword && <em className='form_error'>{errors.cpPassword.message}</em>}
                    </div>
